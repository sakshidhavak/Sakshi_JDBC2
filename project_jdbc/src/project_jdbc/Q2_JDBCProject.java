...
public class Q2_JDBCProject {
	...
	public static void main(String[] args)throws SQLException {
		...
		try {
			...
			String query = "create table  Employee (emp_id int primary key not null, first_name varchar(25),"
					+ " last_name varchar(25), Salary int, dept_id int, email varchar(25), Phone_no varchar(25))";
